...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "../sv-benchmarks/c/pthread/butterfly.c", 6, __extension__ __PRETTY_FUNCTION__); })); }
...
int main()
{
    ...
    pthread_create(&t1, ((void *)0), p0, ((void *)0));
    pthread_create(&t2, ((void *)0), p1, ((void *)0));
    pthread_create(&t3, ((void *)0), p2, ((void *)0));
    pthread_create(&t4, ((void *)0), p3, ((void *)0));
    pthread_create(&t5, ((void *)0), p4, ((void *)0));
    pthread_create(&t6, ((void *)0), p5, ((void *)0));
    pthread_join(t1, 0);
    pthread_join(t2, 0);
    pthread_join(t3, 0);
    pthread_join(t4, 0);

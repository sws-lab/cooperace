...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "generated/unwind3.h", 11, __extension__ __PRETTY_FUNCTION__); })); }
...
int main() {
    _N = 1;
    assume_abort_if_not(0 <= _N && _N <= 0x7fffffff / 2);
    limit = _N;
    for(int i = 0; i < _N; ++i) {
        pthread_t t;

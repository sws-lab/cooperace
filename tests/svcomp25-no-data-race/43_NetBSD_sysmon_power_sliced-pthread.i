...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_NetBSD_sysmon_power_sliced-pthread.c", 4, __extension__ __PRETTY_FUNCTION__); })); }

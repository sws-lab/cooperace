...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "48_ticket_lock_low_contention_vs-pthread.c", 6, __extension__ __PRETTY_FUNCTION__); })); }
...
pthread_mutex_t s = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
unsigned c = 0;
void* thr1(void* arg)
{

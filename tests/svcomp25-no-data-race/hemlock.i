...
{
    hem_node_t *pred = ((void *)0);
    vatomicptr_write_rlx(&node->grant, ((void *)0));
    pred = (hem_node_t *)vatomicptr_cmpxchg_acq(&l->tail, ((void *)0), node);
    return pred == ((void *)0);
}
static inline void
hemlock_acquire(hemlock_t *l, hem_node_t *node)
{
    ...
    vatomicptr_await_neq_acq(&pred->grant, ((void *)0));
    vatomicptr_write_rlx(&pred->grant, ((void *)0));
}
static inline void
hemlock_release(hemlock_t *l, hem_node_t *node)
{
    if (vatomicptr_read_rlx(&l->tail) == node &&
        vatomicptr_cmpxchg_rel(&l->tail, node, ((void *)0)) == node) {
        return;
    }
    vatomicptr_write_rel(&node->grant, l);
    vatomicptr_await_eq_rlx(&node->grant, ((void *)0));
}
static inline int
...
hemlock_t lock1 = { .tail = { ._v = 0 } };
hemlock_t lock2 = { .tail = { ._v = 0 } };
struct hem_node_s nodes[3];
void
